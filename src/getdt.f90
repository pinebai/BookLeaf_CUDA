    ...
    if(iel<=nel) then
      ...
      ELSE
        ...
        ELSE
          ...
          IF (w1.LT.zcut) THEN
               w1 = (0.5_rlk*(elx1+elx2)-elx3)*(0.5_rlk*(elx1+elx2)-elx3) + &
&              (0.5_rlk*(ely1+ely2)-ely3)*(0.5_rlk*(ely1+ely2)-ely3) 
         ELSE
              ...
              w1 = tmp/w1
        ENDIF
        w3 = (ely4-ely1)*(ely4-ely1)+(elx4-elx1)*(elx4-elx1)
        IF (w3.LT.zcut) THEN
...
&              (0.5_rlk*(ely2+ely3)-ely4)*(0.5_rlk*(ely2+ely3)-ely4)
        ...
        ENDIF
        if(w1>w3) w1 = w3
        w3 = (ely1-ely2)*(ely1-ely2)+(elx1-elx2)*(elx1-elx2)
        IF (w3.LT.zcut) THEN
...
&              (0.5_rlk*(ely3+ely4)-ely1)*(0.5_rlk*(ely3+ely4)-ely1)
        ...
        ENDIF
        if(w1>w3) w1 = w3
        w3 = (ely2-ely3)*(ely2-ely3)+(elx2-elx3)*(elx2-elx3)
        IF (w3.LT.zcut) THEN
...
&                              elv=>rscratch22
    ...
    REAL(KIND=rlk),DIMENSION(nel)   :: h_rho05,h_elvol,h_ein05
